...
![Top Predicted PNG](supplied/topPredicted.PNG){style="max-height:300px;"}  

**Figure 3:** Top prediction of the PCB with the dark rectangular prisms being various parts.

![Bottom Predicted PNG](supplied/bottomPredicted.PNG){style="max-height:300px;"}  
...
![Real top unsolder](supplied/topunsolder.PNG){style="max-height:300px;"}  
...
![Real top done](supplied/topFinished.PNG){style="max-height:300px;"}  

**Figure 7:** Top of the PCB after being built.

![Real bottom done](supplied/bottomFinished.PNG){style="max-height:300px;"}  
